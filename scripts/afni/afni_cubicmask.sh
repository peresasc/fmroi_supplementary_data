...
#===========================================================================
# AFNI Cubic ROI Generation
#
# This script generates cubic Region of Interests (ROIs) using the AFNI
...
outdir=/media/andre/data8t/fmroi/fmroi_qc/dataset/afni-cubicmask
...
outpath=$(printf ${outdir}/afni-cubicmask_srcimg_t1_edge_%03d_center_x$(($i+1))y$(($j+1))z$(($k+1)).nii $rvx);

# AFNI command for generating a spherical mask
echo $curpos | 3dUndump -cubes -srad $r -master $srcpath -prefix $outpath -ijk -
